...
const liveFilteredList = computed(() => {
...
const scheduledFilteredItems = computed(() => {
...
const visibleLiveItems = computed(() => liveFilteredList.value.slice(0, liveVisibleCount.value))
const visibleScheduledItems = computed(() => scheduledFilteredItems.value.slice(0, scheduledVisibleCount.value))
