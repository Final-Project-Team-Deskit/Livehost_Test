...
public interface BroadcastRepositoryCustom {
    ...
    List<BroadcastListResponse> findTop5ByStatus(Long sellerId, List<BroadcastStatus> statuses, BroadcastOrderField orderField, boolean isAsc, boolean isAdmin);
    ...
    // 4. 예약 시간대별 카운트 조회 (예약 가능 슬롯 계산용)
    java.util.Map<LocalDateTime, Long> countReservedByScheduledAtBetween(LocalDateTime start, LocalDateTime end);
}
